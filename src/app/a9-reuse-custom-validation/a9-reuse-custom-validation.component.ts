...
@Component({
  selector: 'app-a9-reuse-custom-validation',
  templateUrl: './a9-reuse-custom-validation.component.html',
  styleUrls: ['./a9-reuse-custom-validation.component.css']
})
export class A9ReuseCustomValidationComponent implements OnInit {
