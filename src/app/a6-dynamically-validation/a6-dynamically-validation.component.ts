...
@Component({
  selector: 'app-a6-dynamically-validation',
  templateUrl: './a6-dynamically-validation.component.html',
  styleUrls: ['./a6-dynamically-validation.component.css']
})
export class A6DynamicallyValidationComponent implements OnInit {
