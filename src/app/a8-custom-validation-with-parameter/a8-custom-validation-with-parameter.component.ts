...
@Component({
  selector: 'app-a8-custom-validation-with-parameter',
  templateUrl: './a8-custom-validation-with-parameter.component.html',
  styleUrls: ['./a8-custom-validation-with-parameter.component.css']
})
export class A8CustomValidationWithParameterComponent implements OnInit {
  ...
  ngOnInit() {
    this.employeeForm = this.fb.group({
      ...
      email: ["", [Validators.required,Validators.email, emailDomain('hotmail.com')]],
